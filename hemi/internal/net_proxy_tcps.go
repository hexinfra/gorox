...
func (d *tcpsProxy) OnSetup(conn *TCPSConn) (next bool) {
	// TODO
	return
}
func (d *tcpsProxy) OnInput(buf *Buffer, end bool) (next bool) {
	// TODO
	return
}
func (d *tcpsProxy) OnOutput(buf *Buffer, end bool) (next bool) {
	// TODO
	return
}
