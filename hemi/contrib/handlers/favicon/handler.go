...
// Favicon handlers print the Gorox logo as favicon.
...
func (h *faviconHandler) OnConfigure() {
}
...
func (h *faviconHandler) Handle(req Request, resp Response) (next bool) {
	if status, pass := req.TestConditions(faviconTime, faviconETag, true); pass {
		resp.SetLastModified(faviconTime)
		resp.SetETagBytes(faviconETag)
