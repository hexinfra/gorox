...
func main() {
	...
	//calc([]byte("accept-encoding accept-ranges allow cache-control connection content-encoding trailer transfer-encoding upgrade vary via www-authenticate"))
