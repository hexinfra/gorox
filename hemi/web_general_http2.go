...
type http2Conn_[S http2Stream] struct { // for server2Conn and backend2Conn
	...
	decodeTable  http2Table                       // <= 5 KiB. hpack dynamic table used for decoding field blocks received from remote
	...
	encodeTable  http2Table                       // <= 5 KiB. hpack dynamic table used for encoding field list sent to remote
	// Conn states (zeros)
