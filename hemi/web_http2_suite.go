...
func (c *server2Conn) _joinContinuations(headersInFrame *http2InFrame) error { // into a single headers frame
...
func (c *server2Conn) _growContinuation(size uint32, headersInFrame *http2InFrame) error {
