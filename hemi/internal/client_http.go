...
var ( // perfect hash table for response singleton headers
	...
	hResponseSingletonHeaderTable = [12]struct {
		...
		0:  {desc{hashDate, 46, 50, false, false, false, true}, (*hResponse_).checkDate},
		...
		4:  {desc{hashLastModified, 64, 77, false, false, false, true}, (*hResponse_).checkLastModified},
		5:  {desc{hashLocation, 78, 86, false, false, false, true}, (*hResponse_).checkLocation},
		6:  {desc{hashExpires, 56, 63, false, false, false, true}, (*hResponse_).checkExpires},
		...
		9:  {desc{hashServer, 99, 105, false, false, false, false}, (*hResponse_).checkServer},
		10: {desc{hashContentType, 33, 45, false, false, true, false}, (*hResponse_).checkContentType},
		11: {desc{hashRetryAfter, 87, 98, false, false, false, true}, (*hResponse_).checkRetryAfter},
	}
...
var ( // perfect hash table for response important headers
	...
	hResponseImportantHeaderTable = [17]struct {
		...
		1:  {desc{hashVia, 192, 195, false, false, false, false}, (*hResponse_).checkVia},
