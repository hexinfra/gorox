...
var HuffmanCodes = [256]uint32{ // 1K, for huffman encoding
...
var HuffmanSizes = [256]uint8{ // 256B, for huffman encoding
...
var HuffmanTable = [256][16]struct{ next, sym, emit, end byte }{ // 16K, for huffman decoding
	// TODO
	0x00: {
